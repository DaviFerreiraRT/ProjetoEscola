...
public abstract class AlunoDAO {
    ...
    public static Aluno create(String nome, String sexo) {
        ...
        try {
            ...
            PreparedStatement ps = connection.prepareStatement(
                    "INSERT INTO ALUNOS(NOME,SEXO) VALUE(?,?);",
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null, ""
                        + "Não foi encontrado nenhum aluno com esta matricula");
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
            System.out.println(ex.getMessage());
    ...
    public static void removeById(int matricula) {
        Connection connection = Database.getConnection();
        try {
            PreparedStatement ps = connection.prepareStatement("DELETE FROM ALUNOS"
                    + " WHERE MATRICULA = ?");
            ps.setInt(1, matricula);
    ...
    public static void update(int matricula, String nome, String sexo) {
        ...
        try {
            ...
            if (exec > 0) {
                ...
                JOptionPane.showMessageDialog(null, "Não existe nenhum aluno"
                        + " com esta matricula");
            }
